...
public class ResolveTicketServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(ticketId != null) {
				to.resolveTicket(ticketId);
				output = "<table><tr><th>SUCCESS!  The ticket was resolved.</th></tr></table>";
			} else {
				output = "<table><tr><th>Please verify your inputs and try again.</th></tr></table>";
			}
		} catch (Exception e) {
